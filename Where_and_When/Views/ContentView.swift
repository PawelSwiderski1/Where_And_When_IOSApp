                    ...
                    VStack(spacing: 11){
                        ZStack(alignment: .top){
                            ...
                            ZStack(alignment: .topTrailing){
                                KFImage(URL(string: photo?.url ?? "http://www.historypin.org/en/api/pin/get.json?id=500"))
                                    .resizable()
                                    .scaledToFit()
                                    .onTapGesture {
                                        if showPhotoView{
                        ...
                        if photo != nil{
                            NavigationLink(destination: ResultView(isGameSummary: false, round: gameManager.round, photo: photo!, guessedLocation: mapState.guess, guessedYear: getSliderYear(offset))
                            ){
