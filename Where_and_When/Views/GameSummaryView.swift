        ...
        VStack{
            ...
            if !isMapMaximized{
                ...
                ForEach(1..<6){ round in
                    if gameManager.photos[0] != nil{
                        NavigationLink(destination:
                            ResultView(isGameSummary: true, round: round, photo: gameManager.photos[round-1]!, guessedLocation: gameManager.results[round - 1]!.guessedLocation, guessedYear: gameManager.results[round-1]!.guessedYear))
                        {
